    ...
    return(
        <div className="min-h-screen w-full flex flex-col justify-center items-center p-20 bg-cyan-50">
            ...
            <div className="text-center flex flex-col gap-3">
                ...
                <h1 className="text-3xl md:text-5xl font-bold">Have any questions?</h1>
                <h2 className="text-2xl font-bold">We are here 24/7 to assist you</h2>
                <h3 className="text-xl">Get answers to your questions. Just send us an <Link className="text-2xl font-bold underline" to='/contacts'>email</Link>  and we will contact you ASAP!</h3>
            </div>
