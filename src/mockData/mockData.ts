export const bannerData = {
  ...
  export const customerReviews = [
    {customer : 
    {message : 'It is very calming knowing that you have all of the information available on the car you are buying beforehand. The website offers a very thorough check. Appreciate you guys!',
    customer: "JS",id: '1'}},

    {customer : {message : 'Overall the app is great. It is a bit expensive, but its worth it! It is better to pay a little bit more than to throw thousands of euros for a car you know nothing about. They have already helped me avoid a car with a rolled back odometer so kudos!',
    customer: "Barack",id: '2'}},
