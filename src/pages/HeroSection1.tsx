    ...
    return(
        ...
        <div className="flex w-1/2 h-screen gap-7 px-10 md:px-25 py-15  flex-col">
            ...
            <div className="flex bg-gray-50  p-3 rounded-lg justify-between">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="24" height="24" aria-hidden="true" data-slot="icon"><path fill="currentColor" fill-rule="evenodd" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-8.838-3.7c-.907 0-1.462.626-1.462 1.19a.8.8 0 0 1-1.6 0c0-1.635 1.47-2.79 3.062-2.79 1.591 0 3.062 1.155 3.062 2.79 0 1.393-.847 2.1-1.429 2.57-.638.514-.833.694-.833 1.076v.396a.8.8 0 0 1-1.6 0v-.396c0-1.19.813-1.834 1.323-2.238l.106-.084c.549-.443.833-.73.833-1.325 0-.563-.555-1.189-1.462-1.189Zm-.862 8a.8.8 0 0 0 1.6 0V16a.8.8 0 1 0-1.6 0v.3Z" clip-rule="evenodd"></path></svg>
